			  ...
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav menu__list">
					...
					@foreach (
					App\Model\Category::with('subcategories')
					->where('parent_id', 0)
					->get() as $data
					)
						<li class="dropdown menu__item">
							<a href="#" class="dropdown-toggle menu__link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">{{ $data->name }} <span class="caret"></span>
							</a>
							...
							<ul class="dropdown-menu multi-column columns-3">
								<div class="agile_inner_drop_nav_info">
									...
									<div class="col-sm-6 multi-gd-img multi-gd-text ">
										<a href="womens.html"><img src="{{ asset('user/images/top1.jpg') }}" alt=" "/></a>
									</div>
									<div class="clearfix"></div>
								</div>
							</ul>
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<div class="col-md-4 modal_body_right modal_body_right1">
							<img src="{{ asset('user/images/log_pic.jpg') }}" alt=" "/>
						</div>
						<div class="clearfix"></div>
					</div>
				</div>
